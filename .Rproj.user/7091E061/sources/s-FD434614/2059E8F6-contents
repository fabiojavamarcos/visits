...
visits_class.df <- read.csv('./data/visits_Conference.owl_class_4.csv')
visits_ant_class.df <- read.csv('./data/visits_ant_Conference.owl_class_4.csv')
visits_order_class.df <- read.csv('./data/visits_order_Conference.owl_class_4.csv')
...
stripchart(visitsLoop ~ nodeNumber, visits_class.df, vertical=TRUE,
